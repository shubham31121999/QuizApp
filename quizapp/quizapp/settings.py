...
SECRET_KEY = 'django-insecure-6l6pln)%ssn!91lmyoez90+qazd(&j51*&j37_6=*(xwos1j5w'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Optional if using app templates
...
# For production (optional, when using collectstatic)
